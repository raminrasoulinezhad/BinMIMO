...
void bigamp(opt* opt, cmatrix* A1hatInit, matrix* A1varInit,
		...
		matrix** x12varOpt, cmatrix** A1hatOpt, matrix** A1varOpt) {
	long i,j;	
...
//	setting->nitMin = 0;
	...
	cmatrix* A1hatInit = readFileComplex("A1hatInit.txt");
	matrix* A1varInit = readFileReal("A1varInit.txt");
	cmatrix* x12hatInit = readFileComplex("x12hatInit.txt");
	matrix* x12varInit = readFileReal("x12varInit.txt");

	cmatrix* pilot = readFileComplex("pilot.txt");
	cmatrix* Y = readFileComplex("Y.txt");

	cmatrix* mean0 = readFileComplex("mean0.txt");
	matrix* var0 = readFileReal("var0.txt");
	cmatrix* x0 = readFileComplex("x0.txt");
	...
	bigamp(setting, A1hatInit, A1varInit, x12hatInit, x12varInit, pilot, Y, x0,
			mean0, var0, &x12hatOpt, &x12varOpt, &A1hatOpt, &A1varOpt);
