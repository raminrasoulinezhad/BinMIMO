...
int main(int argc, char** argv) {
    ...
    readFileComplex("data//A.txt",&Channel,&ChannelS1,&ChannelS2,N,K);
	readFileComplex("data/Xdata.txt",&sentData,&sentDataS1,&sentDataS2,K,data_len);
	readFileComplex("data/Xpilot.txt",&sentPilot,&sentPilotS1,&sentPilotS2,K,pilot_len);
	readFileComplex("data/y.txt",&recSym,&recSymS1,&recSymS2,N,T);
